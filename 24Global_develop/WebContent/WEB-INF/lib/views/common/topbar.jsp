...
<nav class="page-controls navbar navbar-dashboard">
    <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                <li class="nav-item">
                    ...
                    <a class="hidden-lg-up nav-link" id="nav-collapse-toggle" href="#" data-html="true" title="Show/hide<br>sidebar" data-placement="bottom">
                        <span class="rounded rounded-lg bg-gray text-white hidden-md-up" style="padding-top: 10px;">
                        	<i class="fa fa-bars fa-lg"></i>
                       	</span>
            ...
            <ul class="nav navbar-nav navbar-right hidden-md-up">
                <li>
                    ...
                    <a href="#" data-toggle="chat-sidebar">
                        <span class="rounded rounded-lg bg-gray text-white" style="padding-top:11px;">
        ...
        <div class="collapse navbar-collapse">
            ...
            <form class="navbar-form pull-xs-left" role="search" style="margin-bottom: 0.5px;">
            ...
            <ul class="nav navbar-nav pull-xs-right">
                        ...
                        <section class="card notifications">
                                ...
                                <div class="btn-group btn-group-sm btn-group-justified" id="notifications-toggle" data-toggle="buttons">
                                    <label class="btn btn-secondary active">
                                        ...
                                        <input type="radio" checked
                                               ...
                                               data-ajax-load="${pageContext.request.contextPath }/demo/ajax/notifications.html"
                                               data-ajax-target="#notifications-list"> Notifications
                                    </label>
                                    <label class="btn btn-secondary">
                                        <input type="radio"
                                               data-ajax-trigger="change"
                                               data-ajax-load="${pageContext.request.contextPath }/demo/ajax/messages.html"
                                               data-ajax-target="#notifications-list"> Messages
                                    </label>
                                    <label class="btn btn-secondary">
                                        <input type="radio"
                                               data-ajax-trigger="change"
                                               data-ajax-load="${pageContext.request.contextPath }/demo/ajax/progress.html"
                            ...
                            <div id="notifications-list" class="list-group thin-scroll">
                                ...
                                <span class="thumb-sm pull-xs-left mr clearfix">
                                    <img class="img-circle" src="${pageContext.request.contextPath }/demo/img/people/a3.jpg" alt="...">
                                </span>
                            ...
                            <footer class="card-footer text-sm">
                                ...
                                <button class="btn-label btn-link pull-xs-right"
                                        ...
                                        data-ajax-load="${pageContext.request.contextPath }/demo/ajax/notifications.php"
                ...
                <li class="dropdown nav-item">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        <li><a class="dropdown-item" href="${pageContext.request.contextPath }/profile.html"><i class="glyphicon glyphicon-user"></i> &nbsp; My Account</a></li>
                        <li class="dropdown-divider"></li>
                        <li><a class="dropdown-item" href="${pageContext.request.contextPath }/calendar.html">Calendar</a></li>
                        <li><a class="dropdown-item" href="${pageContext.request.contextPath }/inbox.html">Inbox &nbsp;&nbsp;<span class="label label-pill label-danger animated bounceIn">9</span></a></li>
                        <li class="dropdown-divider"></li>
                        <li><a class="dropdown-item" href="${pageContext.request.contextPath }/login.html"><i class="fa fa-sign-out"></i> &nbsp; Log Out</a></li>
                    </ul>
                </li>
                <li class="nav-item">
                    ...
                    <div id="chat-notification" class="chat-notification hide">
                        <div class="chat-notification-inner">
                            <h6 class="title">
                                <span class="thumb-xs">
                                    <img src="${pageContext.request.contextPath }/demo/img/people/a6.jpg" class="img-circle mr-xs pull-xs-left">
                                </span>
                                Jess Smith
                            </h6>
