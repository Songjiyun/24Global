...
<nav id="sidebar" class="sidebar" role="navigation">
    ...
    <div class="js-sidebar-content">
        <header class="logo hidden-sm-down">
            <a href="global24.do">Global 24</a>
        </header>
        ...
        <div class="sidebar-status hidden-md-up">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <span class="thumb-sm avatar pull-xs-right">
                    <img class="img-circle" src="${pageContext.request.contextPath }/demo/img/people/a5.jpg" alt="...">
                </span>
        ...
        <ul class="sidebar-nav">
            <!-- <li class="active">
                ...
                <a href="#sidebar-dashboard" data-toggle="collapse" data-parent="#sidebar">
                    <span class="icon">
                        <i class="fa fa-desktop" style="padding-top:7px;"></i>
                    </span>
                    Dashboard
            ...
            <li>
            	<a href="MarketPrice.do">
                    <span class="icon">
                        <i class="fa fa-bell-o" style="padding-top:7px; font-size: 17px;"></i>
                    </span>
                    시세알림
                </a>
            </li>
            <li>
            	<a href="Comunity.do">
                    <span class="icon">
                        <i class="fa fa-bullhorn" style="padding-top:7px; font-size: 17px;"></i>
                    </span>
                    커뮤니티
                </a>
            </li>
            ...
            <li>
                <a href="profile.html">
                    <span class="icon" style="padding-top:7px;">
